      ...
      {meteorStyles.map((style, idx) => (
        <span
          ...
          className={cn(
            ...
            "bg-gradient-to-l from-stone-400 via-stone-300 to-transparent opacity-0",
            className
          )}
          style={{
            top: style.top,
        ...
        >
          <span className="absolute left-0 top-1/2 -translate-y-1/2 h-[3px] w-[3px] rounded-full bg-stone-400 shadow-[0_0_4px_2px_rgba(120,113,108,0.35)]" />
        </span>
      ))}
    </>
  );
